...
if( is_category() ) {
    ...
    $featured_topic = get_field("go-deeper-featured-1", "category_" . $category->term_id)[0];
} else {
    $featured_topic = get_field("go-deeper-featured-1")[0];
}
...
<?php if ($featured_topic) : ?>
    ...
    <div class="sl-go-deeper sl-go-deeper-featured-1">
